import unittest
import solutions._contest.weekly_278.index as main
...
class Test(unittest.TestCase):
    def test_findFinalValue(self):
        test_patterns = [
            ...
            ([2, 7, 9], 4, 4),
            ([8, 19, 4, 2, 15, 3], 2, 16),
            ([161, 28, 640, 264, 81, 561, 320, 2, 61, 244, 183, 108, 773, 61, 976, 122, 988, 2, 370, 392, 488, 375, 349, 432, 713, 563], 61, 1952),
        ]
