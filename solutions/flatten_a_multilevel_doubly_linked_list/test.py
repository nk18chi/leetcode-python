import unittest
import solutions.flatten_a_multilevel_doubly_linked_list.index as main
    ...
    def test_flatten(self):
        ...
        for i, (arg, expected) in enumerate(test_patterns):
            with self.subTest(test=i):
                ...
                self.assertEqual(getFlattenDoublyNode(s.flatten(node)), getFlattenDoublyNode(createDoublyNode(expected)))
